...
<<<<<<< HEAD
    ...
    pending_payments: 'Pending Payments', // New
    incoming_shipments: 'Incoming Shipments', // New
    settle_payment: 'Settle Payment', // New
    add_payment: 'Add Payment', // New
...
<<<<<<< HEAD
    ...
    change_qty: 'Change',
    reference: 'Ref #',
    stock_error_max: 'Cannot add more. Max stock reached.',
    // Time Ranges
...
<<<<<<< HEAD
    ...
    overview: '概览',
    workspace: '工作台', // New
    pending_payments: '待收尾款', // New
    incoming_shipments: '待收货 / 在途', // New
    settle_payment: '结清 / 收款', // New
    add_payment: '追加付款', // New
    amount_to_pay: '支付金额', // New
    fully_paid: '已结清', // New
    payment_added: '付款记录已更新。', // New
    inventory: '库存',
    orders: '销售订单',
    purchase_orders: '进货单',
    settings: '系统设置',
    relationships: '关系管理',
    total_sales: '实收销售额', // Updated
